...
int main(void)
{
	...
	while(1)
	{
		...
		{
			brightness+=20; //increasing more leads to faster reach to full brightness
...
void Timer2_init(void)
{
	...
	htimer2.Init.Period = 10000-1; // the period is 1ms
	...
	tim2PWM_config.Pulse = 0; //25% Duty cycle
